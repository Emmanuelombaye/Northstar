...
const TILES: { id: StoreCategory; label: string; image: string }[] = [
  ...
  { id: "mens-health", label: "Men's Health", image: "/images/store/trt-kit.jpg" },
  { id: "womens-health", label: "Women's Health", image: "/images/store/womens-wellness.jpg" },
  { id: "hair", label: "Hair", image: "/images/store/hair-treatment.jpg" },
  { id: "skincare", label: "Skincare", image: "/images/store/skincare-cream.jpg" },
