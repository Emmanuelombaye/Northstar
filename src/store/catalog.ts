...
export const PHARMACY_CATALOG: PharmacyProduct[] = [
  ...
  item({
    ...
    name: "Tirzepatide+",
    tagline: "Dual GIP/GLP-1 · Metabolic support",
    description: "Weekly dual-pathway injection for appetite control and medical weight management.",
    longDescription: "Our dual-pathway weight management protocol. Licensed clinicians titrate dosing from your intake, labs, and progress.",
    ...
    badge: undefined, popular: true, peakProduct: "tirzepatide",
  }),
  item({
    slug: "semaglutide-plus",
    name: "Semaglutide+",
    tagline: "GLP-1 · Provider-guided weight management",
    ...
    badge: undefined, popular: true, peakProduct: "semaglutide",
  }),
  item({
  ...
  item({
    ...
    badge: undefined, popular: true, peakProduct: "testosterone",
  }),
  item({
    slug: "enclomiphene",
    name: "Enclomiphene",
  ...
  item({
    ...
    badge: undefined, popular: true, peakProduct: "tretinoin",
  }),
  item({
