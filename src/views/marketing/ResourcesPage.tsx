    ...
    <main className="resources-page">
          ...
          <div className="featured-resource">
            <div className="featured-left">
              ...
              <div className="featured-meta">
                ...
                <span style={{ color: "var(--gold)", fontWeight: 600 }}>Medically Reviewed by Dr. Evelyn Sterling, MD</span>
              </div>
            </div>
      ...
      <section className="library-section">
        <div className="res-wrap">
          <div className="library-grid">
            {/* Resource 1: Labs */}
            <article className="resource-card" data-category="diagnostics">
              <span className="resource-tag">Diagnostics &amp; Labs</span>
              <svg viewBox="0 0 24 24" fill="none" style={{ width: 36, height: 36, color: "var(--gold)", marginBottom: 20 }}>
            ...
            <article className="resource-card" data-category="nutrition">
            ...
            {/* Resource 3: Sleep */}
            <article className="resource-card" data-category="sleep">
            ...
            {/* Resource 4: Peptides */}
            <article className="resource-card" data-category="longevity">
      ...
      <section className="newsletter-section">
        <div className="newsletter-inner">
          ...
          <form className="newsletter-form" onSubmit={(e) => { e.preventDefault(); alert('Thank you for subscribing! Your longevity briefings will arrive shortly.'); }}>
