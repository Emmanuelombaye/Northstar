...
import { useSearchParams } from "@/lib/routerAdapter";
...
import { groupProductsByCategory, sortCatalogProducts } from "../store/shopifyMeta";
    ...
    <main className="shop-page pharm-store">
      ...
      <section className="pharm-section">
        <div className="pharm-wrap">
          ...
          <p className="pharm-section-sub">
            Physician-guided programs · U.S. pharmacy fulfillment · charged only if prescribed
          </p>
      ...
      <section id="catalog" className="pharm-section pharm-catalog">
        <div className="pharm-wrap">
          ...
          <p className="pharm-section-sub">
            {PRODUCT_COUNT} North Star MD programs · licensed U.S. pharmacy fulfillment
          </p>
          ...
          {showCollections ? (
            <div
              className="pharm-collections-wrapper"
              style={{ marginTop: "32px", display: "flex", flexDirection: "column", gap: "60px" }}
            >
              {collections.map((col) => (
