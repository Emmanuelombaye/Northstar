...
export const POLICIES: PolicyDoc[] = [
  {
    ...
    lead: 'How telehealth services may be provided through the North Star MD platform.',
    body: `This Telehealth Consent explains how telehealth services may be provided through the Northstar® platform. By using the Northstar® Services, completing an assessment, submitting information, or proceeding with provider review, you consent to receive care through telehealth where permitted by applicable law.

Northstar® is not a pharmacy and does not itself practice medicine. Medical services, if available, are provided by independent US-licensed providers or affiliated clinical partners.
...
2. Asynchronous Care
Care through Northstar® is often delivered asynchronously, meaning a US-licensed provider reviews your information and communicates with you at separate times rather than during a real-time visit.
...
8. Emergency Care
If you are experiencing a medical emergency, call 911 or seek emergency medical care immediately. Northstar® should not be used for emergencies.
...
Northstar® uses reasonable administrative, technical, and physical safeguards designed to protect your information.
...
You may decline or withdraw consent to telehealth at any time by discontinuing use of the Services or contacting support. Withdrawing consent may limit your ability to receive services through Northstar®.
...
13. Contact Us
Questions about this Telehealth Consent can be sent to support@joinnorthstarmd.com.`,
  },
  {
    slug: 'hipaa-notice',
...
Questions may be sent to privacy@joinnorthstarmd.com or support@joinnorthstarmd.com.`,
  },
  {
    slug: 'terms-of-use',
    ...
    updated: 'August 17, 2026',
    lead: 'Terms governing your access to North Star MD websites, assessments, checkout, and related services.',
    body: `1. INTRODUCTION
These Terms of Use govern your access to and use of the websites, online services, assessments, checkout flows, patient-facing technology, communications, and related non-clinical services provided by Northstar MD LLC d/b/a Northstar (the “Company,” “we,” “our,” or “us”) (collectively, the “Services”). By accessing or using the Services, you agree to these Terms.
...
* uploading viruses, malicious code, or harmful materials
...
29. CONTACT US
Questions about these Terms may be directed to Northstar MD LLC, 5 Courtenay Delorme Bradshaw Sole M 3500 Oak Lane Ave STE 460 Dallas, TX 75219, support@joinnorthstarmd.com, (903) 746 5367.`,
  },
  {
    ...
    body: `The information provided through the Northstar® website, assessments, product pages, checkout flows, communications, and related services is for general informational purposes only and is not a substitute for professional medical advice, diagnosis, or treatment.

1. Informational Use Only
All content on the Northstar® Services—including text, graphics, images, assessments, product descriptions, and other materials—is provided for general informational purposes only. It is not intended to be, and should not be relied upon as, medical advice or a recommendation for any particular treatment, medication, or course of action.

2. Not Medical Advice
Use of the Northstar® Services does not create a doctor-patient relationship with Northstar®. Content on the Services does not constitute medical advice, diagnosis, or treatment. Always seek the advice of a qualified healthcare provider with any questions you may have regarding your health or a medical condition.

3. Northstar® Is Not a Pharmacy
Northstar® is not a pharmacy and does not itself practice medicine. Medical services, if available, are provided by independent US-licensed providers or affiliated clinical partners.
...
Northstar® does not guarantee specific outcomes, results, eligibility, prescriptions, weight loss, hair regrowth, performance improvement, energy improvement, anti-aging benefits, or treatment availability.
...
Northstar® may coordinate access to independent providers, pharmacies, payment processors, fulfillment partners, or other service providers. These third parties may have their own policies, notices, and responsibilities.
...
14. Contact Us
Questions about this Medical Disclaimer can be sent to support@joinnorthstarmd.com.
Northstar MD LLC d/b/a Northstar®`,
  },
  {
    slug: 'privacy-policy',
    ...
    updated: 'August 17, 2026',
    lead: 'How North Star MD collects, uses, shares, and protects information on the platform.',
    body: `This Privacy Policy describes how Northstar MD LLC d/b/a Northstar® (“Northstar®,” “we,” “our,” or “us”) collects, uses, shares, and protects information when you use our websites, online services, assessments, checkout flows, communications, and related services (collectively, the “Northstar® Services”).

1. Introduction
Northstar® provides a technology platform that connects users with independent US-licensed providers and licensed pharmacies. Northstar® is not a pharmacy. Prescription treatment, if any, is provided only after review by a US-licensed provider and only if clinically appropriate. Services may not be available in all states.
If you are experiencing a medical emergency, call 911 or seek emergency medical care immediately. The Northstar® Services are not for use in emergencies.

2. Information We Collect
We collect information directly from you, automatically through your use of the Northstar® website and platform, and from third parties such as service providers, clinical partners, and payment processors.

3. Information You Provide to Us
We collect information you provide when you create an account, complete an assessment, communicate with providers or support, place an order, or otherwise interact with the Northstar® Services. This may include your name, date of birth, contact details, demographic information, account credentials, shipping address, identification information where required, and the contents of messages you send us.
...
We use information to provide and operate the Northstar® Services, facilitate provider review, support pharmacy fulfillment where applicable, process payments, communicate with you, personalize and improve the Services, prevent fraud and abuse, ensure security, and comply with legal and regulatory obligations.
...
Payment information may be collected and processed by third-party payment processors. Northstar® does not store complete payment card numbers unless expressly stated by the payment processor. We may receive limited information such as billing details, last four digits, card brand, and transaction status.

11. Online Analytics and Advertising
We may work with analytics and advertising partners to understand how the Northstar® Services are used and to deliver relevant marketing. These partners may use cookies and similar technologies to collect information about your activity over time and across services. Depending on your jurisdiction, you may have the right to opt out of certain advertising and analytics processing.
...
Depending on your state of residence, you may have the right to request access, correction, deletion, portability, or opt-out rights regarding certain personal information. To submit a request, contact privacy@joinnorthstarmd.com.
...
California residents may have additional rights under the California Consumer Privacy Act (CCPA), as amended, including the right to know the categories and specific pieces of personal information collected, the right to delete, the right to correct, the right to limit use of sensitive personal information, and the right to opt out of certain sharing or sale as defined under California law. To exercise these rights, contact privacy@joinnorthstarmd.com.

15. Nevada Privacy Rights
Nevada residents may have the right to direct us not to sell certain covered information as defined under Nevada law. To submit a request, contact privacy@joinnorthstarmd.com.

16. Children’s Privacy
The Northstar® Services are intended for adults 18 years of age or older. We do not knowingly collect personal information from children under 13. If you believe a child has provided personal information, contact privacy@joinnorthstarmd.com and we will take appropriate action.

17. How We Protect Information
We use administrative, technical, and physical safeguards designed to protect information. No system is 100% secure, and we cannot guarantee absolute security of information transmitted to or from the Northstar® Services.

18. Retention of Information
We retain information for as long as necessary to provide the Northstar® Services, comply with legal and regulatory obligations (including medical recordkeeping requirements), resolve disputes, and enforce our agreements.
...
20. Contact Us
For privacy questions or to exercise your rights, contact privacy@joinnorthstarmd.com.
Northstar MD LLC d/b/a Northstar®

21. Cookie Notice
Our use of cookies and similar technologies is described in Section 6 above. You may manage your preferences through your browser settings or any cookie preference tools made available within the Northstar® platform.`,
  },
]
